...
*   **Latent Diffusion Models**: Moving beyond transformers to diffusion-based generation of cell states.
*   **Arc Institute's Model**: Anticipated releases following the Virtual Cell Challenge.
